...
const newBtn = document.querySelector('#yesBtn').addEventListener('click', success);
const nBtn = document.querySelector('#noBtn').addEventListener('click', generateNumber);

function success() {
    var text = document.getElementById("successTxt");
...
function generateNumber() {
    ...
    document.getElementById('randomNumber').innerText = "Is this it?" + randomNum;
    ...
    var tl = TimelineLite({paused: true}),
    dots = [],
